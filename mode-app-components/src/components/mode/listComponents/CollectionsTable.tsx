 ...
 */
export interface DisplayableCollectionsTableDataItem {
    readonly id?: string;
 ...
 */
export interface CollectionsTableDataItem extends BaseListCompDataItem<TimeSeriesCollectionInfo> {
    readonly displayValue: DisplayableCollectionsTableDataItem;
}


/**
 * Table columns setting for CollectionsTable. CollectionsTable columns settings MUST contain these column keys
 */
interface CollectionsTableFieldsSet extends BaseListCompFieldsSet {
    ...
    readonly valueNames?: BaseListCompField;
    readonly tagNames?: BaseListCompField;
}


export interface CollectionsTableProps extends BaseCollectionsListProps {
    readonly listData: readonly CollectionsTableDataItem[] | undefined;
    readonly fieldsSettings: BaseListCompFieldsSettings<CollectionsTableFieldsSet>;
...
/**
 * This is an implementation of CollectionsTable component that display list of CollectionInfo in table form.
 */
                    ...
                    <>
                        <div className={classes.tableContainer}>
                            <Table className={tableClasses.root} size="medium">
                                ...
                                <TableBody>
                                    {props.listData.map((dataItem: CollectionsTableDataItem): JSX.Element => {
                                        return (
                                            <TableRow
